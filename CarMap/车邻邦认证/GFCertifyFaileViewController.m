//
//  GFCertifyFaileViewController.m
//  CarMap
//
//  Created by 陈光法 on 16/12/1.
...
@interface GFCertifyFaileViewController ()
{
...
@implementation GFCertifyFaileViewController
...
- (void)viewDidLoad {
    ...
    //            [_identityImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://10.0.12.221:12345/%@", dataDic[@"idPhoto"]]] placeholderImage:[UIImage imageNamed:@"userImage"]];
...
- (void)setViewForCertify{
    ...
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(failLabel1.frame) + 15, self.view.frame.size.width-20, 1)];
