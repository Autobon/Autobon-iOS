...
//    NSString *timeString = [formatter stringFromDate:date];
    ...
    timeLabel.text = [NSString stringWithFormat:@"工作时间：%@",_model.orderTime];
    ...
    // 立即抢单
    UIButton * _certifyButton = [[UIButton alloc]initWithFrame:CGRectMake(_orderView.frame.size.width/4, _orderView.frame.size.height-_orderView.frame.size.height/18-10, _orderView.frame.size.width/2, self.view.frame.size.height/18)];
