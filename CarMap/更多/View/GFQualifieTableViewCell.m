...
@implementation GFQualifieTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if(self != nil) {
        ...
        lab1.text = @"能力项目: ";
        NSString *lab1Str = @"美容清洁发生的接口附近阿里斯顿换个房间按数量的啥地方哈说了的发送旅客嘎哈该发生的合法老师的挥发时间的发顺丰撒地方哈施法时间和法国是";
