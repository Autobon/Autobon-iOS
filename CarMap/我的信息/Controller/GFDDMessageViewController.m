...
//    [_scView addSubview:failLabel1];
    ...
    [self _setjishiWithX:0 withY:CGRectGetMaxY(idImageLabel.frame) + 10 + 30 * 5 withXingji:[_model.otherLevel integerValue] withNianxian:_model.otherLevel withTitle:@"其他"];
